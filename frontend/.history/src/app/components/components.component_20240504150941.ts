      ...
      this.ytService.downloadVideo(this.videoURL, this.selectedResolution).subscribe(
        (event: any) => {
          if (event.type === "downloadProgress") {
            ...
            this.saveFile(event, "video.mp4"); // Save the file instead of using Blob URL
            this.downloading = false;
          }
        },
        (error) => {
      ...
      this.ytService.downloadAudio(this.videoURL).subscribe(
        (event: any) => {
          if (event.type === "downloadProgress") {
            ...
            this.saveFile(event, "audio.mp3"); // Save the file instead of using Blob URL
            this.downloading = false;
          }
        },
        (error) => {
      ...
      this.ytService.downloadShortMp4(this.videoURL).subscribe(
        (event: any) => {
          if (event.type === "downloadProgress") {
            ...
            this.saveFile(event, "short_video.mp4");
            this.downloading = false;            
          }
        },
        (error) => {
      ...
      this.ytService.downloadAudio(this.videoURL).subscribe(
        (event: any) => {
          if (event.type === "downloadProgress") {
            ...
            this.saveFile(event, "shorts_audio.mp3");
            this.downloading = false;
          }
        },
        (error) => {
