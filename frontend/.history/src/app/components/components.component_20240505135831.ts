...
export class ComponentsComponent implements OnInit, OnDestroy {
  @ViewChild('section1') section1: ElementRef | undefined;
  @ViewChild('section2') section2: ElementRef | undefined;
  sectionToScroll: ElementRef | undefined;
  ...
  scrollToSection(sectionName: string) {
    // Set the sectionToScroll reference based on the sectionName parameter
    if (sectionName === 'section1' && this.section1) {
      this.sectionToScroll = this.section1;
    } else if (sectionName === 'section2' && this.section2) {
      this.sectionToScroll = this.section2;
    }
  }
