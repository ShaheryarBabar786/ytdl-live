...
router.post('/downloadvideomp4', async (req, res) => {
    ...
    try {
        ...
        // Add your code for processing and streaming the video here
        // For example:
        // const format = info.formats.find(f => f.itag == itag);
        // if (!format) {
        //     throw new Error('Requested format not available.');
        // }
        // res.setHeader('Content-Disposition', `attachment; filename="${sanitize(info.videoDetails.title)}.mp4"`);
        // res.setHeader('Content-Type', 'video/mp4');
        // const videoStream = ytdl(videoURL, { format });
        // videoStream.pipe(res);
        ...
        // Uncomment and modify the above code according to your needs
